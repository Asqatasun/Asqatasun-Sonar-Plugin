...
public final class Rgaa3Profile extends BaseProfileDefinition {
  ...
  protected String getProfileName() {
    return AsqatasunRuleTags.RGAA3;
  }

  @Override
  protected boolean isTagIncluded(Class ruleClass) {
    AsqatasunRuleTags ruleAnnotation = AnnotationUtils.getAnnotation(ruleClass, AsqatasunRuleTags.class);
    return Arrays.asList(ruleAnnotation.value()).contains(AsqatasunRuleTags.RGAA3);
  }
