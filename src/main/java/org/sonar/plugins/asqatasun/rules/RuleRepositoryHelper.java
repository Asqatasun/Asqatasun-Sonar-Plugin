...
public final class RuleRepositoryHelper {
  ...
  public static Rule createRule(String repositoryKey, Class clazz, org.sonar.check.Rule ruleAnnotation, @Nullable AsqatasunRuleTags ruleTagsAnnotation) {
  ...
  private static void setTags(Rule rule, @Nullable AsqatasunRuleTags ruleTagsAnnotation) {
